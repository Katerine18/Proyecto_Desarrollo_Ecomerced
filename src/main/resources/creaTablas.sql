/*Se crea la base de datos */ -- PRIMER PASO --
drop schema if exists tecnotopia;
drop user if exists usuario_Proyecto;
CREATE SCHEMA tecnotopia ;
-----------------------------------------------------------------------------------------------------------------
/*Se crea un usuario para la base de datos llamado "usuario_prueba" y tiene la contraseña "Usuario_Clave."*/ -- SEGUNDO PASO --
create user 'usuario_Proyecto'@'%' identified by 'Usuar1o_Clave.';
-----------------------------------------------------------------------------------------------------------------
/*Select para ver usuarios y modificar*/ -- SE UTILIZA SOLO PARA REVISAR EL USUARIO --
SELECT * FROM mysql.user WHERE user = 'usuario_Proyecto';
...
create table tecnotopia.categoria (
...
-----------------------------------------------------------------------------------------------------------------
/* la tabla de productos*/ -- QUINTO PASO --
create table tecnotopia.producto (
...
-----------------------------------------------------------------------------------------------------------------
-- OMITIR DE MOMENTO --
create table tecnotopia.factura (
...
-----------------------------------------------------------------------------------------------------------------
/*Se insertan 3 categorias de productos como ejemplo */ -- SEXTO PASO --
INSERT INTO tecnotopia.categoria (id_categoria,descripcion,ruta_imagen,activo) VALUES 
...
INSERT INTO tecnotopia.producto (id_producto,id_categoria,descripcion,detalle,precio,existencias,ruta_imagen,activo) VALUES
...
INSERT INTO tecnotopia.factura (id_factura,id_usuario,fecha,total,estado) VALUES
...
-----------------------------------------------------------------------------------------------------------------
INSERT INTO tecnotopia.venta (id_venta,id_factura,id_producto,precio,cantidad) values
(1,1,5,45000,3),
(2,1,9,15780,2),
(3,1,10,15000,3),
(4,2,5,45000,1),
...
DEFAULT CHARACTER SET = utf8mb4;
-----------------------------------------------------------------------------------------------------------------
insert into tecnotopia.rol (id_rol, nombre, id_usuario) values
